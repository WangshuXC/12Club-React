<template>
    <button
        class="w-[36px] h-[36px] border base-bg-100 hover:bg-gray-200 border-neutral-300 dark:hover:bg-gray-800 dark:border-zinc-600 justify-around inline-flex items-center rounded-md shadow-sm cursor-pointer"
        @click="useToggleDark">
